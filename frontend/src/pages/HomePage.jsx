    ...
    <>
      <div className="bg-gradient-to-r from-green-400 to-blue-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          ...
          <h2 className="text-5xl font-bold text-center">
            Transform Your Financial Habits with Ease
          </h2>

          {/* Subheading */}
          <p className="mt-4 text-xl text-center">
            Join thousands who have simplified their financial tracking with SpendWise.
          </p>
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-white text-green-500 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300 cursor-pointer">
              Get Started
            </button>
          </Link>
        </div>
      ...
      <div className="bg-blue-500 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-4">
          Start managing your expenses effortlessly with SpendWise.
          </p>
          <Link to="/register">
